...
$string['datasource_help'] = 'Seleccione una opción si desea procesar las respuestas obtenidas del módulo "Resultados BFI", de lo contrario seleccione la opción "Subir archivo" para procesar sus respuestas.';
